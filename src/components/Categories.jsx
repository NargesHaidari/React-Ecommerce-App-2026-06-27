...
export default function FeaturedProducts(){
    ...
    <div className='px-48 w-full grid grid-cols-4 gap-2'>
        ...
        categoriesProducts.map((item)=>(
            <div className='flex flex-col items-center justify-end p-3 rounded-2xl h-[400px] bg-cover bg-no-repeat bg-center' style={{backgroundImage:`url(${item.image})`}} key={item.key}>
                <div className='flex flex-col items-center bg-black/30 w-full rounded-2xl py-2'>
                    ...
                    <a href="" className='text-white text-2xl hover:scale-105 transition-all duration-200 active:scale-100'>{item.category}</a>
